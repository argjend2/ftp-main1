...
mkdir -p /game/public
cd /game/public
wget https://dl.rehlds.ru/server/rehlds_linux_server.zip
yum install unzip
unzip rehlds_linux_server.zip
rm -rf rehlds_linux_server.zip
cd rehlds_linux_server
chmod +x hlds_run
chmod +x hlds_linux
cd
...
echo "HLDS path is /game/public/rehlds_linux_server"
